...
define config.name = _("Key of Freedom Halls of Bone")
...
define build.name = "KeyofFreedomHallsofBone"
...
define config.save_directory = "KeyofFreedomHallsofBone-1759053076"
